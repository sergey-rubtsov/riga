...
public class RunGTFS2MATSimExample {
	...
	public static void main(String[] args) {
		...
		//input data
		String gtfsZipFile = "data/gtfs.zip";
		...
		//output files 
		String scheduleFile = "scenarios/transitSchedule.xml.gz";
		String networkFile = "scenarios/network.xml.gz";
		String transitVehiclesFile ="scenarios/transitVehicles.xml.gz";
		...
		org.matsim.contrib.gtfs.TransitSchedulePostProcessTools.copyLateDeparturesToStartOfDay(scenario.getTransitSchedule(), 24 * 3600, "copied", false);
		org.matsim.contrib.gtfs.TransitSchedulePostProcessTools.copyEarlyDeparturesToFollowingNight(scenario.getTransitSchedule(), 6 * 3600, "copied");
