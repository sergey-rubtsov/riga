 ...
 * @author mrieser / SBB
 */
public class SimpleTransitQSimEngine extends TransitQSimEngine /*implements DepartureHandler, MobsimEngine, AgentSource*/ {

    private static final Logger log = Logger.getLogger(SimpleTransitQSimEngine.class);

    private final SimpleTransitConfigGroup config;
    ...
    @Inject
    public SimpleTransitQSimEngine(QSim qSim, ReplanningContext context) {
        super(qSim);
        this.qSim = qSim;
        this.context = context;
        this.config = ConfigUtils.addOrGetModule(qSim.getScenario().getConfig(), SimpleTransitConfigGroup.GROUP_NAME, SimpleTransitConfigGroup.class);
    ...
    public void setInternalInterface(InternalInterface internalInterface) {
        ...
        this.deterministicDriverFactory = new SimpleTransitDriverAgentFactory(internalInterface, this.agentTracker, this.config.getDeterministicServiceModes());
    ...
    private void handleDeterministicDriverDeparture(MobsimAgent agent, double now) {
        SimpleTransitDriverAgent driver = (SimpleTransitDriverAgent) agent;
    ...
    private void handlePassengerExchange(TransitEvent event) {
        SimpleTransitDriverAgent driver = event.context.driver;
    ...
    private void precomputeLinkEvents(double depTime, double arrTime, Link[] linksToNextStop, TransitVehicle vehicle, SimpleTransitDriverAgent driver) {
