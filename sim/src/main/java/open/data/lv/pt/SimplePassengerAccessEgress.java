 ...
 * @author mrieser / SBB
 */
public class SimplePassengerAccessEgress implements PassengerAccessEgress {
    ...
    SimplePassengerAccessEgress(InternalInterface internalInterface, TransitStopAgentTracker agentTracker, Scenario scenario, EventsManager eventsManager) {
