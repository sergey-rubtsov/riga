 ...
 * @author mrieser / SBB
 */
public class SimpleTransitDriverAgent extends TransitDriverAgentImpl {

    private TransitRouteStop currentStop;
    private TransitRouteStop nextStop;
    private final EventsManager eventsManager;
    private final SimplePassengerAccessEgress accessEgress;
    private TransitRoute currentTransitRoute;
    private LinkedList<TransitRouteStop> remainingRouteStops = null;

    SimpleTransitDriverAgent(Umlauf umlauf, String transportMode, TransitStopAgentTracker agentTracker, InternalInterface internalInterface) {
        super(umlauf, transportMode, agentTracker, internalInterface);
        this.eventsManager = internalInterface.getMobsim().getEventsManager();
        this.accessEgress = new SimplePassengerAccessEgress(internalInterface, agentTracker, internalInterface.getMobsim().getScenario(), this.eventsManager);
        checkCurrentRoute();
    }
